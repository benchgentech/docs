...
- [A2A Inspector](https://github.com/a2aproject/a2a-inspector) - Testing and validation tool
- [Agent2Agent (A2A) Protocol](https://a2a-protocol.org/)
- [SSE (Server-Sent Events) Reference](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events)
...
- Use the [A2A Inspector](https://github.com/a2aproject/a2a-inspector) to test and debug your connections
